...
class TestQuestions(unittest.TestCase):
    def setUp(self):
        ...
        #post 3 questions
        self.client().post('/api/v1/questions', headers=dict(Authorization="Bearer " + self.a_token), content_type="application/json", data=json.dumps({"title": "Git branching", "content": "How to create and checkout a branch in git"}))
    ...
    def test_delete_questions(self):
        ...
        result2 = self.client().delete('/api/v1/questions/2', headers=dict(Authorization="Bearer " + self.a_token2))
        my_data2 = ast.literal_eval(result2.data)
        ...
        result4 = self.client().delete('/api/v1/questions/0', headers=dict(Authorization="Bearer " + self.a_token2))
        ...
        #test missing question
        result5 = self.client().delete('/api/v1/questions/10', headers=dict(Authorization="Bearer " + self.a_token2))
